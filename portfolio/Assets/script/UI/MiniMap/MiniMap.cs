...
{    
    ...
    public void MapSetting()        //맵 바꿀때
    {
        ...
        {
            miniMap_n_Max_Min();
            MapSprite_n.sprite = ResourceManager.resource.GetImage(GameManager.gameManager.MapName);
        }
        else
        {
            MapSprite_n.sprite = ResourceManager.resource.GetImage(GameManager.gameManager.MapName);
        ...
        {
            miniMap_M_Max_Min();
            MapSprite_M.sprite = ResourceManager.resource.GetImage(GameManager.gameManager.MapName);
            miniMap_M_Max_Min();
        }
        else
        {
