...
public class Quest
{
    ...
    public List<int> PrecedeQuest { get; set; }

    public Quest(int _index, string _questName,string _Type, string _questExplain,string _goalType, int _goal_Index,int _goal_Need,string _State = "NONE",List<int> _precedQuest = null)
    {
        QUESTTYPE questType;
        GOALTYPE goalType;
